...
| 2026-08-09 | `std/socket` pass-through wrappers recurse | [aura#2865](https://github.com/cybrid-systems/aura/issues/2865) **P0** | `(define (tcp-listen p) (tcp-listen p))` shadows prim → `()`. Use bare host prims until fixed. |
